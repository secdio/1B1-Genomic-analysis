      seqfile =  data1.phy            * Path to the alignment file
     treefile = RadA_8_1b1PCC10605.nwk           * Path to the tree file
      outfile = out_1b1PCC10605_branchsite_null.txt            * Path to the output file
